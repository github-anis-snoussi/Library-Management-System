    ...
    def Handle_Login(self):
        ...
        for row in data : 
            if username == row[1] and password == row[3] :
                ...
                self.label.setText("Make sure of credentials")
...
class MainApp(QMainWindow , Ui_MainWindow):
    ...
    def Handle_Buttons(self):
        ...
        self.pushButton_22.clicked.connect(self.Export_Day_Operations)
    ...
    def Export_Day_Operations(self) :
        ...
        work_book = Workbook('day_operations.xlsx')
        sheet1 = work_book.add_worksheet()
        sheet1.write(0,0,'book title')
        sheet1.write(0,1,'operation type')
        sheet1.write(0,2,'number of days')
